import Button_general from "../Button_general/Button_general"
...
<div className="col-lg-4 col-sm-12 py-2">
 <div id="OS-card-Posts" className="card">
                            <div className="card-body">
                                <h2 className="OS-Card-blogs-title">Financial Accountant</h2>
                                <div className="d-flex flex-wrap justify-content-between">
                                    <div>
                                        <img src={Icon_1} alt="this ic icon" />
                                        <span className="OS-span_2-posts px-1">Closed</span>
                                    </div>
                                    <span className="OS-span_3-posts align-items-center">02:30 pm 2022/08/23</span>
                                </div>
                                 <h3 className="OS-posts-decription py-5">
