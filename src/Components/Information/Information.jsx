...
import Navbar_Virtual from '../Navbar_Virtual/Navbar_Virtual'
import Card_Information from '../Card_Information/Card_Information'
import Button_general from '../Button_general/Button_general'
const Information = ({ toggle }) => {
    return (
        <div>
            <Navbar_Virtual toggle={toggle}/>
